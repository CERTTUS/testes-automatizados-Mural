...
import {evidenciarPassoSmokePreCr} from '../../helpers/pre-cr/evidenciarSmokePreCr';
...
test.describe('Smoke — descrição da sugestão (IN-884)', () => {
   ...
   test('CT-SMK-01 — Abrir o mural autenticado e ver a listagem', async ({page}, testInfo) => {
      ...
      await evidenciarPassoSmokePreCr(page, testInfo, 'CT-SMK-01', 1, 'listagem-mural');
   ...
   test('CT-SMK-02 — Abrir nova sugestão e ver o contador 0/2000', async ({page}, testInfo) => {
      ...
      await evidenciarPassoSmokePreCr(page, testInfo, 'CT-SMK-02', 1, 'listagem-mural');
      ...
      await evidenciarPassoSmokePreCr(page, testInfo, 'CT-SMK-02', 2, 'formulario-nova-sugestao');
